...
date: 2026-08-07
tags: [library, dj, incomplete, to-research]
---

# Incomplete Albums

Releases sitting in `~/Music/Library/` with only *some* of their tracks — each folder was deliberately kept under its real album/EP name (not `Singles/`) so the rest can drop in later. This is the "what's left to hunt for" list, checked against each release's full Discogs (or Bandcamp) tracklist.
...
| Artist — Release | Have | Missing tracks | Library path | Source |
|---|---|---|---|---|
...
| Keinemusik — Send Return | 1/12 | Send Return, Confusion, Saving My Love, Pussy Power, Discoteca, The Day I Met You, Paris, Love Jones, What You Expected, Pay To Play, Before The Flood | `Keinemusik/Send Return/` | [Discogs ↗](https://www.discogs.com/release/21778720) · [[june-2026]] |
...
| Surgeon — Surgeon EP *(Atol)* | 1/4 | Magneze, Move, Argon | `Surgeon/Surgeon - Surgeon (2014 Remaster) [16B-44.1kHz]/` | [Discogs ↗](https://www.discogs.com/release/6105590) · [[june-2026]] |
| UFO95 — Popularity Is Overrated | 3/8 | Sun s4lutation, Enchanted Forest, Rrkja, Œ, Volcano | `UFO95/UFO95 - 2020 - Popularity Is Overrated [Mama Told Ya] [FLAC]/` | [Discogs ↗](https://www.discogs.com/release/15908066) · [[june-2026]] |
| Viper Diva — Broken Dreams Club EP | 1/3 | 24/7 You, Love & Riot | `Viper Diva/[SAIKE04] Broken Dreams Club [2023] [FLAC]/` | [Discogs ↗](https://www.discogs.com/release/26809574) · [[july-2026]] |
| Viper Diva — Snake Does Cry EP | 2/3 | Horny Consequences | `Viper Diva/[SAIKE02] Snake Does Cry [2021] [FLAC]/` | [Discogs ↗](https://www.discogs.com/release/16878069) · [[july-2026]] |
| VÍZ — Danse des Larmes | 1/8 | Eden X, Danse des Larmes, Hyperálom, 222, Vali 2.0, Tűz Tó, Eternia Now | `VÍZ/VÍZ - 2025 - Danse des Larmes [Heat Crimes] [FLAC]/` | [Bandcamp ↗](https://heatcrimes.bandcamp.com/album/danse-des-larmes) · [[june-2026]] |

## How to update

- **New partial pull:** when a monthly note logs a release as `(X of Y)` / `(track N only)` and the folder is kept under its real album name (not `Singles/`) for more to join, add a row here.
- **Filled in more tracks:** update the Have/Missing columns; if it's now complete, delete the row (and drop the ✅ note in the monthly log if worth flagging).
- **Skip:** VA-comp single-track pulls and cases where the missing track is already owned under a different release — those aren't gaps.
