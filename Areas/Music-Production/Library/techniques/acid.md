...
| Oscillator | Osc 1 Saw, or Pulse / Rectangle (Drift has both) for a hollower tone | [manual] waveforms · [start] tone |
| Filter | Low-pass, high resonance (~60–80%), short envelope decay | [start] |
| Accent | Drift Mod section: Source **Velocity** → Destination **LP Frequency** (±100%) | [manual] |
| Pattern | 16ths, a few octave jumps, overlapping notes = slides [manual], 2–4 accents per bar [start] | [manual] · [start] |
| Movement | Automate cutoff + resonance over 16–32 bars | [start] |
| Chain | Saturator/Roar → Echo (low mix) → EQ Eight | [start] |
...
- Which tools suit acid best is a taste call. [start]

## Gotchas
- It sits above the bass, and should blend with the drums rather than sit on top of them. [start]
