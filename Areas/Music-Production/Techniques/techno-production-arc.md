...
| 3 | **Movement** | Something small changes every 8/16 bars — filter sweeps, velocity, delay throws | [[../Ableton/clip-envelopes\|clip envelopes]], Delay | ✅ known |
| 4 | **Tension tools** | Risers, crashes, and the kick drop | clip envelopes, [[techno-arrangement-sections\|section moves]] | ✅ known |
| 5 | **Structure** | Scenes → record to Arrangement; DJ-friendly: long drums-only intro/outro | Session→Arrangement record | ✅ known |
| 6 | **Mix** | Level hierarchy, EQ carving, **sidechain ducking**, saturation | Channel EQ, Compressor (sidechain), Saturator | 🟡 partial — ducking 🆕 queued |
| 7 | **Export** | WAV render | `Cmd+Shift+R` | ✅ known |

## The techno-specific principles

- **Few elements, much repetition.** A club techno track is often 5–7 sounds total. Interest comes from *variation of the same parts* (stage 3), never from adding more parts.
- **The mix hierarchy**: kick loudest → bass/rumble felt → hats/perc crisp but behind → musical elements under the drums. Techno mixes drums-forward.
...
5 Lead/perc synth    6 FX/riser    7–8 spare (atmos, extra perc)
```
