---
title: Companies — Berlin
date: 2026-06-14
tags: [portfolio, career, job-search, berlin]
---
...
| Company | Industry | Size | Why it fits | Links | Status |
|---|---|---|---|---|---|
| Esther Schipper | arts (gallery) | Small | Top Berlin gallery — **was hiring a Gallery Assistant** (organised, service role): a clean entry point | estherschipper.com | todo |
| Sprüth Magers | arts (gallery) | Big | World-leading contemporary gallery, Berlin HQ | spruethmagers.com | todo |
| König Galerie | arts (gallery) | Small | Dynamic Berlin gallery, has a careers page | koeniggalerie.com | todo |

## Design / creative studios
| Company | Industry | Size | Why it fits | Links | Status |
|---|---|---|---|---|---|
| Bureau Borsche | design-studio · fashion | Small | Top studio, fashion clients (Balenciaga, Supreme, Nike) | bureauborsche.com | todo |
| Studio Yukiko | design-studio | Small | Art direction / branding, internet & youth culture; award-winning | y-u-k-i-k-o.com | todo |
| HORT | design-studio · music | Small | Iconic Berlin studio (roots in record covers) | *(verify URL)* | todo |
| Edenspiekermann | design-studio · tech/product | Small | Brand + product + dev, Erik Spiekermann lineage | edenspiekermann.com | todo |
...
| Company | Industry | Size | Why it fits | Links | Status |
|---|---|---|---|---|---|
| Ableton | music · tech/product | Big | Music software — ties to the Ableton learning; for later | ableton.com | todo (future) |
