...
- **Sidebar colour palettes**: themable palette for `PlaylistSidebarView` highlight and accent. Reuse the palette concept from the original Culla app. Blue (default), black, white, pastel, neon...
