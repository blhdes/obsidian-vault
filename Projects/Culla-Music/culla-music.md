...
**Web:** [culla.app/music](https://culla.app/music) — landing + privacy (`#privacy`) + support (`#support`), in the `culla-web` repo. App Store submission guide → [[Resources/Xcode/app-store-submission|App Store submission]].  
**Started:** 2026-05-03 | **Status (2026-09-14):** **Live on the App Store**, version 1.5.0 (build 2), submitted 2026-07-27. **Phase 7 shipped** — an Insights screen (sorting stats, streaks, taste profile, top artists), screenshot tooling for the store listing, swipe-card/play-disc choreography rework, and a run of dismissed-count/catalog-reconciliation fixes. → [[Phases/phase-07-insights-screenshots-and-submission|Phase 7]].

_Before that:_ Phase 6 shipped — new surfaces (History sheet, album liner-notes sheet, date jump), a real first-run experience (brand splash + one-time swipe guide), deeper iOS 26 Liquid Glass morphing, data-integrity fixes, and the full **release-readiness** push: **localization into 8 languages** + App Store prep (bundle id `app.culla.music`, iPhone-only, version-only footer). The Phase 4 Dismissed cleanup menu was dropped (undo now lives in History). → [[Phases/phase-06-surfaces-onboarding-and-release|Phase 6]].
...
- **Phase 7** — [[Phases/phase-07-insights-screenshots-and-submission|Insights, Screenshot Tooling & App Store Submission]]. ~40 commits, 2026-06-14 → 2026-07-27. Insights screen (stats, streaks, taste profile, top artists — ships the Stats/activity idea), screenshot-tooling for the store listing (brand-mark/glass covers, rights-safe editorial-notes rendering), swipe-card/play-disc choreography rework, dismissed-count/catalog-reconciliation fixes, and the **submitted 1.5.0 (build 2)** App Store listing.
...
- ✅ [[Archive/Culla-Music/Ideas/stats-activity-view|Stats / activity view]] — shipped Phase 7 as the Insights screen (`3642c91`, `c7cc848`); went beyond the sketch with a taste profile, coverage, and artist tap-through. [[Phases/phase-07-insights-screenshots-and-submission|Phase 7]].
...
- **Hands-on QA gap (now very large)** — [[qa-testing-tracker|QA Testing Tracker]]'s last logged pass is still **2026-05-22**. Everything since — the post-Phase-5 polish, the entire Phase 6, and the entire Phase 7 (Insights, screenshot tooling, choreography rework, the submitted 1.5.0 build) — is unverified on device: ~4 months / 110+ commits behind. Biggest ongoing risk. Localized layouts (longer DE/FR strings) especially need an eyeball.
