...
date: 2026-07-23
tags: [ableton, instrument-rack, key-zones, workflow]
---
...
- **Chain 2 (LEAD):** a new Drift patch → Phaser-Flanger, key-zoned above it (C5 and up) — matching the already-known "lead sits on top" register-lane rule from [[Resources/Music-Production/Techniques/bleep-lead-motif|Bleep Lead & Motif Writing]].
